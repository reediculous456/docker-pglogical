...
RUN echo "host    replication          postgres                172.18.0.0/16   trust" >> /usr/share/postgresql/11/pg_hba.conf.sample
RUN echo "host    replication          postgres                ::1/128         trust" >> /usr/share/postgresql/11/pg_hba.conf.sample
